...
class POSOrder(models.Model):
	...
	def _order_fields(self, ui_order):
		_logger.info('PosPaymentMethod:_order_fields')
		amount_total = []
		...
		return {
			...
			'pos_order_prefix': ui_order['pos_order_prefix'] or '',
			'pos_order_date': ui_order['pos_order_date'] or '',
			'pos_order_remark': ui_order['pos_order_remark'] or '',
			'pos_order_remark_internal': ui_order['pos_order_remark_internal'] or '',
		}
